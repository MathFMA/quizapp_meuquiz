...
function alterarAssunto() {
   ...
   const iconeImg = document.querySelector(".assunto_icone")
...
async function buscarPerguntas() {
   ...
   await fetch(urlDados).then(respostas => respostas.json()).then(dados => {
...
function guardarRepsota(evento) {
...
async function iniciar() {
   ...
   inputReposta.forEach(input => {
      input.addEventListener("click", guardarRepsota)
   })
}
